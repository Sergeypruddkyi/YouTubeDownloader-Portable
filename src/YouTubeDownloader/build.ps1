...
& $csc /nologo /target:winexe /platform:anycpu /optimize+ /codepage:65001 /win32manifest:$manifest /out:$outExe /r:System.dll /r:System.Core.dll /r:System.Windows.Forms.dll /r:System.Drawing.dll /r:Microsoft.CSharp.dll @files
